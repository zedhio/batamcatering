                        ...
                        <div class="card-body card-padding p-t-20 card-body-padding">
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled">
                              ...
                              <input type="text" name="event" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty" placeholder="Masukkan nama event">
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled strong">
                              ...
                              <textarea name="alamat" rowspan="1" class="form-control" placeholder="Masukkan alamat: Ngemplak, Sleman, Yogyakarta"></textarea>
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled">
                              ...
                              <input type="date" name="tgl_event" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty" placeholder="Masukkan tanggal event">
