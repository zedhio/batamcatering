                        ...
                        <div class="card-body card-padding p-t-20 card-body-padding">
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled">
                              ...
                              <input type="text" name="nama" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty" value="<?php echo $testimoni['nama']; ?>">
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled">
                              ...
                              <input type="text" name="jabatan" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty" value="<?php echo $testimoni['jabatan']; ?>">
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled strong">
                              ...
                              <textarea name="testimoni" rowspan="1" class="form-control"><?php echo $testimoni['testimoni']; ?></textarea>
                    ...
                    <div class="col-md-4 col-sm-12 padding-right">
                      <div class="bgm-white cardcontainer">
                        <div class="card-body card-padding p-t-20 card-body-padding">
                          ...
                          <div class="form-group">
                            <div class="fg-line disabled">
                              <?php if (empty($testimoni['foto'])): ?>
                                <img src="<?php echo base_url("assets/img/testimoni/no_image.png"); ?>" height="100" class="radius">
                              <?php else: ?>
                                <img src="<?php echo base_url("assets/img/testimoni/".$testimoni['foto']); ?>" height="100" class="radius">
                              <?php endif ?>
                            </div>
                          </div>
                          ...
                          <div class="form-group padding-top">
                            <div class="fg-line disabled">
                              <strong class="f-13">Foto : <?php echo $testimoni['foto']; ?></strong>
