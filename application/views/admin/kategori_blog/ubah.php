          ...
          <div class="row">
            ...
            <nav aria-label="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url("") ?>" class="bold">Home</a></li>
                <li class="breadcrumb-item"><a href="<?php echo base_url("admin/kategori-blog") ?>">Kategori Blog</a></li>
                        ...
                        <div class="card-body card-padding p-t-20">
                          ...
                          <div class="form-group">
                            <div class="fg-line disabled">
                              ...
                              <input type="text" name="nama_kategori_blog" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty" value="<?php echo $kategori['nama_kategori_blog']; ?>">
