                      ...
                      <div class="card-body card-padding p-t-20 card-body-padding">
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['nama_kategori']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['judul']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['min_required']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled strong">
                            ...
                            <textarea name="deskripsi" rowspan="4" class="form-control" disabled><?php echo $produk['deskripsi']; ?></textarea >
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['seo_title']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['seo_deskripsi']; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled">
                            ...
                            <input type="text" class="form-control f-14 ng-pristine ng-untouched ng-valid ng-not-empty readonly" value="<?php echo $produk['seo_keyword']; ?>" disabled>
                          </div>
                        </div>
                      ...
                      <div class="card-body card-padding p-t-20 card-body-padding">
                        ...
                        <div class="form-group padding-top">
                          <div class="fg-line disabled strong">
                            ...
                            <br>
                            <input type="checkbox" <?php  if ($produk['featured']=="ya") {echo "checked";}; ?> disabled>
                          </div>
                        </div>
                        ...
                        <?php foreach ($detail_produk as $key => $value): ?>
                          ...
                          <div class="form-group">
                            <div class="fg-line disabled" align="center">
                              <strong class="f-12"><?php echo $value['nama_produk']; ?></strong>
                            </div>
                          </div>
                        <?php endforeach ?>
